...
#SBATCH --job-name=Fusion_segHead
...
python -m torch.distributed.launch --nproc_per_node=8 \
    ...
    --pretrained /blue/hmedeiros/khademi.zahra/MOTR-train/MOTR_mask_AppleMOTS_train/MOTR-segmentation-FeatureFusion/outputs/pretrained_weights/model_motr_final.pth \
    --output_dir /blue/hmedeiros/khademi.zahra/MOTR-train/MOTR_mask_AppleMOTS_train/MOTR-segmentation-FeatureFusion/outputs/model_checkpoints/ \
    --batch_size 1 \
    ...
    --extra_track_attn \
    --mot_path /blue/hmedeiros/khademi.zahra/MOTR-train/MOTR_mask_AppleMOTS_train/MOTR-segmentation-FeatureFusion/data/Dataset/ \
