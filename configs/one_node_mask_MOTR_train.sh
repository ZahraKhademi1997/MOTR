...
#SBATCH --job-name=applemots_train
...
python -m torch.distributed.launch --nproc_per_node=4 \
    ...
    --lr 2e-4 \
    --lr_backbone 2e-5 \
    --lr_segmentation_bbox_attention_q_linear 4e-5 \
    --lr_segmentation_bbox_attention_k_linear 4e-5 \
    --lr_segmentation_mask_head_lay1 4e-5 \
    --lr_segmentation_mask_head_gn1 4e-5 \
    --lr_segmentation_mask_head_lay2 4e-5 \
    --lr_segmentation_mask_head_gn2 4e-5 \
    --lr_segmentation_mask_head_lay3 4e-5 \
    --lr_segmentation_mask_head_gn3 4e-5 \
    --lr_segmentation_mask_head_lay4 4e-5 \
    --lr_segmentation_mask_head_gn4 4e-5 \
    --lr_segmentation_mask_head_lay5 4e-5 \
    --lr_segmentation_mask_head_gn5 4e-5 \
    --lr_segmentation_mask_head_out_lay 4e-5 \
    --lr_segmentation_mask_head_adapter1 4e-5 \
    --lr_segmentation_mask_head_adapter2 4e-5 \
    --lr_segmentation_mask_head_adapter3 4e-5 \
