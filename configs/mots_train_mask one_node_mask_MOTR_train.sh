...
python -m torch.distributed.launch --nproc_per_node=4 \
    ...
    --lr 2e-4 \
    --lr_backbone 2e-5 \
    --lr_PerPixelEmbedding 4e-6 \
    --lr_AxialBlock 2e-6 \
    --lr_seg_branches 2e-6 \
    --lr_pos_cross_attention 2e-6 \
    --output_dir /blue/hmedeiros/khademi.zahra/MOTR-train/MOTR_mask_AppleMOTS_train/MOTR-mask-MOT17-Cross-AA/outputs/model_checkpoints/ \
    --batch_size 1 \
    ...
    --extra_track_attn \
    --mot_path /blue/hmedeiros/khademi.zahra/MOTR-train/MOTR_mask_AppleMOTS_train/MOTR-mask-MOT17-Cross-AA/data/Dataset/ \
