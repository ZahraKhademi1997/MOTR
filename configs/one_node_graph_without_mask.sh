...
#SBATCH --job-name=model_graph_without_mask
...
python -m torch.distributed.launch --nproc_per_node=8 \
    ...
    --lr 2e-4 \
    --lr_backbone 2e-5 \
    --output_dir /blue/hmedeiros/khademi.zahra/MOTR_graph/model_graph_without_masks/output \
    --batch_size 1 \
    ...
    --extra_track_attn \
    --mot_path /blue/hmedeiros/khademi.zahra/MOTR_graph/model_graph_without_masks/data/Dataset/ \
