...
#SBATCH --job-name=query_selection
...
module load conda/24.3.0 gcc/12.2.0
...
python -m torch.distributed.launch --nproc_per_node=8 \
    ...
    --lr_mask_embed 2e-4 \
    --lr_bbox_embed 2e-4 \
    --pretrained /blue/hmedeiros/khademi.zahra/MOTR-train/MOTR_mask_AppleMOTS_train/MOTR-mask-Query-Selection/outputs/pretrained_weights/model_motr_final.pth \
    --output_dir /blue/hmedeiros/khademi.zahra/MOTR-train/MOTR_mask_AppleMOTS_train/MOTR-mask-Query-Selection/outputs/model_checkpoints/ \
    --batch_size 1 \
    ...
    --extra_track_attn \
    --mot_path /blue/hmedeiros/khademi.zahra/MOTR-train/MOTR_mask_AppleMOTS_train/MOTR-mask-Query-Selection/data/Dataset/ \
