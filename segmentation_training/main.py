...
#     parser.add_argument('--num_queries_one2one', default=100, type=int,
#                         help="Number of one2one query slots")
#     parser.add_argument('--num_queries_one2many', default=900, type=int,
#                         help="Number of one2many query slots")
...
#             writer = SummaryWriter(log_dir=f"/blue/hmedeiros/khademi.zahra/MOTR-train/MOTR_mask_AppleMOTS_train/MOTR-hybrid_matching/outputs/logs/logs_loss/fold_{fold+1}")
...
def get_args_parser():
    ...
    parser.add_argument('--lr_transformer_names', default=["transformer"], type=str, nargs='+')
    parser.add_argument('--lr_transformer', default=2e-4, type=float)
    ...
    parser.add_argument('--num_queries_one2one', default=100, type=int,
                        help="Number of one2one query slots")
    parser.add_argument('--num_queries_one2many', default=500, type=int,
                        help="Number of one2many query slots")
    parser.add_argument('--dec_n_points', default=4, type=int)
    parser.add_argument('--enc_n_points', default=4, type=int)
    parser.add_argument('--decoder_cross_self', default=False, action='store_true')
    ...
    parser.add_argument('--data_txt_path_train',
                        default='./datasets/data_path/coco.train', type=str,
                        help="path to dataset txt split")
    parser.add_argument('--data_txt_path_val',
                        default='./datasets/data_path/coco.train', type=str,
                        help="path to dataset txt split")
    ...
    parser.add_argument('--exp_name', default='submit', type=str)
    parser.add_argument('--memory_bank_score_thresh', type=float, default=0.)
    parser.add_argument('--memory_bank_len', type=int, default=0)
