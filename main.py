...
def main(args):
    ############################################################################
    # () Logging
    writer = SummaryWriter(log_dir='/blue/hmedeiros/khademi.zahra/MOTR-train/MOTR_mask_AppleMOTS_train/MOTR-mask-AppleMOTS-MaskFormer/outputs/logs/logs_loss')
    ############################################################################
    ...
    model.to(device)
    # output_dir = "/blue/hmedeiros/khademi.zahra/MOTR-train/MOTR-mask-AppleMots-ConnectedComponents/outputs/model.txt"
