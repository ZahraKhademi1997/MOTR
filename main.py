...
def main(args):
    ...
    if args.dataset_file in ['e2e_mot', 'e2e_dance', 'mot', 'ori_mot', 'e2e_static_mot', 'e2e_joint']:
        ...
        for fold, (train_index, val_index) in enumerate(kf.split(np.arange(len(dataset_train)))):
            ...
            writer = SummaryWriter(log_dir=f"/blue/hmedeiros/khademi.zahra/MOTR-train/MOTR_mask_AppleMOTS_train/MOTR-mask-QS-trk-frozen/outputs/logs_focal/logs_loss/fold_{fold+1}")
