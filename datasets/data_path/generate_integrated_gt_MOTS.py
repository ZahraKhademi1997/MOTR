    ...
    with open(input_file, 'r') as file, open(output_file_path, 'w') as out_file:
        for line in file:
            ...
            if object_id != 0:
                ...
                out_file.write(f"{frame_id},{object_id},{xmin},{ymin},{width},{height},{rle}\n")


# input_file_path = '/home/zahra/Documents/Projects/prototype/MOTR-codes/test_mask/MOTR-MOTR_version2_mask_applemots/data/Dataset/MOT17/MOTS/train/images/MOTS20-11/gt/gt.txt'  
# output_directory = '/home/zahra/Documents/Projects/prototype/MOTR-codes/test_mask/MOTR-MOTR_version2_mask_applemots/data/Dataset/MOT17/MOTS/train/gt_with_ids/MOTS20-11'  
...
label_root = f'/home/zahra/Documents/Projects/prototype/MOTR-codes/test_mask/MOTR-MOTR_version2_mask_applemots/data/Dataset/MOT17/MOTS/train/labels_with_ids/'
info_root = f'/home/zahra/Documents/Projects/prototype/MOTR-codes/test_mask/MOTR-MOTR_version2_mask_applemots/data/Dataset/MOT17/MOTS/train/images/'
...
for seq in seqs:
    ...
    gt_txt = osp.join(seq_root, seq, 'gt.txt')
    seq_label_root = osp.join(label_root, seq, 'img1')
    mkdirs(seq_label_root)
    
    col_names = ['frame_id', 'track_id', 'x', 'y', 'w', 'h', 'rle']
