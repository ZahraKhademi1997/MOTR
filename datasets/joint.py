...
class DetMOTDetection:
    ...
    def __getitem__(self, idx):
        ...
        def plot_image_with_bboxes_and_masks(img, bboxes, masks, title):
            ...
            # Save the figure
            output_path = os.path.join('/blue/hmedeiros/khademi.zahra/MOTR-train/MOTR_mask_AppleMOTS_train/MOTR-segmentation-head-training/output/plot_check_joint', file_name)
...
def make_transforms_for_mots(image_set, args=None):
        ...
        def __call__(self, images, all_targets):
            ...
            for img_idx, (image, targets) in enumerate(zip(images, all_targets)):
                ...
                if not valid_crop_found:
                    ...
                    save_failed_image_path = "/blue/hmedeiros/khademi.zahra/MOTR-train/MOTR_mask_AppleMOTS_train/MOTR-segmentation-head-training/output/customcropping"  
    ...
    save_path = "/blue/hmedeiros/khademi.zahra/MOTR-train/MOTR_mask_AppleMOTS_train/MOTR-segmentation-head-training/output/data_aug"
...
def build_dataset2transform(args, image_set):
    ...
    applemots_train = make_transforms_for_mots('train', args)
    applemots_val = make_transforms_for_mots('val', args)
    
    mots_train = make_transforms_for_mots('train', args)
    mots_val = make_transforms_for_mots('val', args)

    
    dataset2transform_train = {'MOT17': mot17_train, 'CrowdHuman': crowdhuman_train, 'MOTS':mots_train, 'APPLE_MOTS':applemots_train}
    dataset2transform_val = {'MOT17': mot17_test, 'CrowdHuman': mot17_test, 'MOTS':mots_val, 'APPLE_MOTS':applemots_val}
