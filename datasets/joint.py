...
class DetMOTDetection:
    ...
    def __getitem__(self, idx):
        ...
        # (5) Checking after transformation masks and bboxes equality 
        def plot_image_with_bboxes_and_masks(img, bboxes, masks, title):
            ...
            # Save the figure
            output_path = os.path.join('/blue/hmedeiros/khademi.zahra/model_graph/output/plot_check_joint', file_name)
        ...
        for img_i, targets_i in zip(images, targets):
            ...
            # (6) Checking masks and bboxes equality
            ...
            # (7) Making number of masks and bboxes equal
            if len(targets_i['masks']) != len(targets_i['boxes']):
                ...
                mask_to_box_mapping = [False] * len(targets_i['masks'])  
...
###############################################################################
# (8) Adding data augmentation for AppleMOTS
...
def make_transforms_for_applemots(image_set, args=None):
        ...
        def __call__(self, images, all_targets):
            ...
            for img_idx, (image, targets) in enumerate(zip(images, all_targets)):
                ...
                if not valid_crop_found:
                    ...
                    save_failed_image_path = "/blue/hmedeiros/khademi.zahra/model_graph/output/customcropping"  
    ...
    save_path = "/blue/hmedeiros/khademi.zahra/model_graph/output/data_aug"
