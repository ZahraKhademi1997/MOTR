...
class DetMOTDetection:
    ...
    def __getitem__(self, idx):
        ...
        def plot_image_with_bboxes_and_masks(img, bboxes, masks, title):
            ...
            # Save the figure
            output_path = os.path.join('/blue/hmedeiros/khademi.zahra/MOTR-train/original_MOTR_APPLEMOTS/MOTR-main/output/plot_check_joint', file_name)
...
###############################################################################
# (7) Adding data augmentation for AppleMOTS
...
def make_transforms_for_applemots(image_set, args=None):
        ...
        def __call__(self, images, all_targets):
            ...
            for img_idx, (image, targets) in enumerate(zip(images, all_targets)):
                ...
                if not valid_crop_found:
                    ...
                    save_failed_image_path = "/blue/hmedeiros/khademi.zahra/MOTR-train/original_MOTR_APPLEMOTS/MOTR-main/output/customcropping"  
    ...
    save_path = "/blue/hmedeiros/khademi.zahra/MOTR-train/original_MOTR_APPLEMOTS/MOTR-main/output/data_aug"
