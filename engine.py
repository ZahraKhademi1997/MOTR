...
def train_one_epoch_mot(model: torch.nn.Module, criterion: torch.nn.Module,
    ...
    writer_grad = SummaryWriter('/blue/hmedeiros/khademi.zahra/MOTR-train/MOTR_mask_AppleMOTS_train/MOTR-mask_AppleMOTS-InstanceAware/outputs/logs/logs_grads') 
    def log_gradients(model, writer_grad, epoch, iteration):
        ...
        modules = {
            ...
            'seg_encoder' : model.transformer.seg_encoder,
            ...
            # 'mask_head/embedding': model.mask_head.embedding,
            ...
            'dynamic_encoder' : model.dynamic_encoder,
