...
class ClipMatcher(SetCriterion):
    ...
    def forward(self, outputs, input_data: dict):
        ...
        # print('input data in forward of the matcher is:', input_data)
...
class MOTR(nn.Module):
    ...
    def forward(self, data):
        ...
        def create_dummy_targets(num_instances=79, img_shape=(736, 1021)):
            ...
            targets = {'masks': masks, 'boxes': boxes, 'labels': labels, 'obj_ids': obj_ids, 'area': area}
            return targets
        ...
        ## getting tensor data instead of dict
